        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CYBERSECURITY</h3>
              <h4>Penetration Testing & Threat Detection</h4>
              <p>
                Cybersecurity student with hands-on experience in penetration
                testing, malware analysis, vulnerability assessment (Nessus),
                and building security-focused Python tools.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Scripts, Scrapers & AI Tools</h4>
              <p>
                I build practical Python tools — web scrapers, automation
                pipelines, FastAPI backends, and ML models. My FYP is a
                phishing detection system with 93% accuracy.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
